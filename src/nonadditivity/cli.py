...
def main():
    ...
    parser.add_argument("-in", required=True, dest="infile", help="Input file")
    parser.add_argument(
        "-update", action="store_true", help="Use fragmentation and images from previous run"
    )
    parser.add_argument(
        "-max_heavy", type=int, default=70, help="Maximum number of heavy atoms per ligand"
    )
    parser.add_argument(
        "-no_chiral",
        action="store_true",
